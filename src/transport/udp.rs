...
/// Incoming packet data with source address.
#[derive(Debug, Clone)]
...
/// UDP endpoint for sending and receiving datagrams.
///
/// Provides async send/receive operations over UDP with
...
impl UdpEndpoint {
    /// Bind to a local address and create a new UDP endpoint.
    ...
    /// Start receiving packets and forwarding to the broadcast channel.
    ///
    /// This spawns a background task that continuously receives datagrams.
    ...
    /// Send a datagram to multiple destinations (for multicast).
...
/// Create a UDP socket pair (connected sockets for bidirectional communication).
///
/// This is useful for testing or loopback scenarios.
