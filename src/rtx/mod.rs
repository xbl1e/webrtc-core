...
/// RTX sequence number for RTX packets.
...
/// Packet history for NACK handling.
...
/// RTX sender for handling retransmissions.
...
/// Information about a packet that needs to be retransmitted.
#[derive(Clone, Debug)]
...
/// RTX receiver for handling incoming RTX packets.
